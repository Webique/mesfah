...
import { Armchair, Clock, DollarSign, Gauge, Settings, Sparkles, Users, Wrench } from "lucide-react";
import * as m from "motion/react-m";
import ExportedImage from "next-image-export-optimizer";
import { useTranslations } from "next-intl";

const FEATURE_ICONS = [Wrench, DollarSign, Settings, Users, Gauge, Sparkles, Armchair, Clock];
...
export default function ServiceCenterSection() {
  ...
  return (
    <section id="service-center" className="py-20 max-w-screen overflow-hidden relative bg-muted">
      <div className="absolute inset-0 bg-gradient-to-b from-transparent via-primary/5 to-transparent pointer-events-none" />

      <div className="layout flex flex-col items-center gap-16 lg:grid lg:grid-cols-2 relative">
        ...
        >
          <div className="relative rounded-3xl overflow-hidden shadow-2xl group">
            ...
            <ExportedImage
              src="/images/service_center.jpeg"
              alt="Service Center"
              width={500}
              height={500}
